...
const revealElements = document.querySelectorAll('.section, .project-card, .expertise-card, .contact-card, .timeline-item');
...
const phrases = ['Systems Architect', 'Database Engineer', 'Academic Leader', 'Full-Stack Developer'];
...
window.addEventListener('scroll', () => {
    ...
    if (!ticking) {
        window.requestAnimationFrame(() => {
            const scrolled = lastScrollY * 0.05;
